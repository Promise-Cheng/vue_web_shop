          ...
          <div class="panel panel-default">
            <div style="padding: 10px 0 20px 10px;">
              <a href="https://gitee.com/Promise-Cheng/mall-project" target="_blank">
                <img src="../../assets/css/admin/dist/img/newbee-logo.png" style="width: 480px;height: 240px;">
              ...
              <ul>
                <li><a href="https://github.com/Promise-Cheng/vue_web_shop" target="_blank">newbee-mall in GitHub</a></li>
                <li><a href="https://gitee.com/Promise-Cheng/mall-project" target="_blank">newbee-mall in Gitee</a></li>
              </ul>
            </div>
          </div>
        </div>
