<template>
  <content id="content">
    <div id="banner" style="display: flex;justify-content: space-between;flex-direction: row;">
      <div class="all-sort-list">
        <template v-for="(category,index) in categories">
          <div class="item" :key="`user${index}`">
            <a-popover placement="right">
              <template slot="content">
                <div class="content-card" v-for="secondLevelCategory in category.secondLevelCategoryVOS"
                     :key="secondLevelCategory.categoryId">
                  <div class="content-title">{{ secondLevelCategory.categoryName }}</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getCategories() {
        api.good.categories().then(res => {
          this.categories = _.cloneDeep(res.data)
        });
      }
    }
  };
